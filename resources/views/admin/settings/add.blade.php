                ...
                <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if(isset($Setting) && $Setting->site_favicon)

                            <div class="mb-2">

                                <img src="{{ asset('images/' . $Setting->site_favicon) }}" alt="User Image" class="img-thumbnail" width="100">

                            </div>

                            <input type="hidden" value="{{(isset($Setting)?$Setting->site_favicon:old('image'))}}" class="form-control" name="site_logo" autocomplete="off">
