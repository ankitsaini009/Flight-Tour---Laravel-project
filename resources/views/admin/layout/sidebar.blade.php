<div class="dlabnav">
    <div class="dlabnav-scroll">
        ...
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="{{route('manage_about.show')}}" aria-expanded="false">
            ...
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('flight.index')}}">Flight Bookings</a></li>
                    <li><a href="{{route('hotel.index')}}">Hotel Booking</a></li>
                    <li><a href="{{route('carrentals.index')}}">Car Rentals</a></li>
                    <li><a href="{{route('airportTaxis.index')}}">AirPort Taxis</a></li>
                    <li><a href="{{route('attraction.index')}}">Attractions</a></li>
                </ul>
            </li>
