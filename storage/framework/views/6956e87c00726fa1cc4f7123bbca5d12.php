    ...
    <section
        ...
        <div
            ...
            <div
                ...
                <form action="<?php echo e(route('frontuser.password.email')); ?>" class="block mt-4 text-start lg:mt-9 md:mt-5" method="post">
                    <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/user_login/forgot-password.blade.php ENDPATH**/ ?>