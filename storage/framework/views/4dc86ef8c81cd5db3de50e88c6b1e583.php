    ...
    <section class="signin md:py-16 py-8 bg-[#003b951a] bg-no-repeat xl:bg-auto lg:bg-[length:25%_auto] bg-[length:18%_auto]" style="background-image: url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-one.webp')); ?>'), url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-two.webp')); ?>'); background-position: center left, center right;">
        <div class="container relative mx-auto after:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-four.webp')); ?>')] after:absolute after:top-0 after:left-0 xl:after:right-[132px] after:lg:right-2.5 after:right-0 after:bottom-0 after:bg-right-bottom after:-z-[1] after:bg-no-repeat after:lg:bg-[length:auto_auto] after:bg-[length:20%_auto] before:bg-[length:36%_auto] before:xl:bg-[length:auto_auto] before:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-three.webp')); ?>')] before:absolute before:top-0 before:left-0 before:w-full before:bottom-0 before:bg-left-top before:-z-[1] before:bg-no-repeat before:md:block before:hidden after:md:block after:hidden">
            <div class="lg:px-6 md:px-4 px-2.5 bg-white border border-[#0000001a] rounded-2xl md:py-9 py-6 xl:w-[41%] lg:w-1/2 md:w-4/6 w-full mx-auto text-center">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('front.create_user_2')); ?>" class="block mt-4 text-start lg:mt-9 md:mt-5">
                    <!-- Password Field -->
                    ...
                    <div class="w-full border rounded-[5px] border-[#9E9E9E] px-3.5 py-1.5 flex md:gap-x-4 gap-x-2 h-14 md:mb-7 mb-5">
                        <img src="<?php echo e(asset('front_assets/images/flight-tour-password-key.svg')); ?>" alt="key" width="24" height="24">
...
</html><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/user_login/creatpass.blade.php ENDPATH**/ ?>