...
<head>
    ...
    <link href="<?php echo e(asset('admin_assets/vendor/jquery-nice-select/css/nice-select.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('admin_assets/vendor/owl-carousel/owl.carousel.css')); ?>" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="brand-logo">
                ...
                <img src="<?php echo e(asset('admin_assets/images/logo-land.png')); ?>" alt="" style="width:255px;">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    ...
                                    ?>
                                    <img src="<?php echo e(asset('images/' . $authdataimg)); ?>" alt=""> </a>
        ...
        ***********************************--><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/admin/layout/header.blade.php ENDPATH**/ ?>