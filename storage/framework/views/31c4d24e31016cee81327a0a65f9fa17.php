...
<body>
        ...
        <div class="container m-auto">
                ...
                <div class="flex flex-col w-full text-white">
                    <div class="flex items-center justify-between px-5 py-4 border-b border-b-black">
                        <a href="<?php echo e(route('front.index')); ?>">
                            ...
                            <?php else: ?>
                            <img src="<?php echo e(asset('images/' . $settings->site_logo)); ?>" alt="Logo" width="180" height="48">
                            <?php endif; ?> </a>
            ...
            <div id="offcanvas" class="flex items-center justify-between ">
                ...
                <ul class="items-center hidden navbar lg:flex xl:gap-7 lg:gap-5 md:gap-3">
                    <li><a href="<?php echo e(route('front.index')); ?>" class="xl:text-xl lg:text-lg text-base pb-2 border-b-2 border-[#115779] text-dark-blue transition">Home</a></li>
                ...
                <ul class="flex items-center gap-1 md:gap-4 navbar nav-right">
                    <li class="flex gap-1 lg:gap-x-5 md:gap-x-3">
                        ...
                        <a href="<?php echo e(route('front.login')); ?>" class="login flex items-center justify-center w-[70px] xl:w-[141px] xl:h-[56px] md:w-[110px] md:h-[45px] h-[30px] text-[14px] md:text-[20px] text-[#F9F9F9] bg-dark-blue hover:bg-transparent hover:border-dark-blue hover:text-[#505673] hover:border rounded transition">Login</a>
                        <?php else: ?>
                        <?php
                        ...
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="<?php echo e(asset('images/' . ($authdataimg ?? '1727852246.webp'))); ?>" style="width: 74px;" alt="userImage">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="<?php echo e(route('frontuserprofile')); ?>" class="dropdown-item ai-icon">
                                <i class="fa-solid fa-user"></i>
                                <span class="ms-2">Profile</span>
                            </a>
                            <a href="<?php echo e(route('userchangepass')); ?>" class="dropdown-item ai-icon">
                                <i class="fa-solid fa-unlock-keyhole"></i>
                                <span class="ms-2">Change password</span>
                            </a>
                            <a href="<?php echo e(route('userlogout')); ?>" class="dropdown-item ai-icon">
    ...
    </header><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/layout/header.blade.php ENDPATH**/ ?>