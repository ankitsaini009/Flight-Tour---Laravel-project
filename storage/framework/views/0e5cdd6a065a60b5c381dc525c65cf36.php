...
<section class="hero">
    ...
    <img src="<?php echo e(asset('front_assets/images/flight-tour-bg-home.webp')); ?>" alt="flight-tour-bg-home" width="1440" height="702" class="w-full">
        ...
        <div class="flex items-center justify-center content ">
            ...
            <div x-data="{ openTab: 1 }" class="w-full ">
                ...
                <div class="mx-auto">
                    ...
                    <div class="grid items-center justify-center w-full grid-cols-3 px-2 py-4 mx-auto space-x-2 bg-white md:space-x-6 md:w-10/12 md:flex lg:px-6 tab-links mb-[-1px]">
                        ...
                        <button x-on:click="openTab = 1" :class="{ ' border-b-2 text-dark-blue border-dark-blue ': openTab === 1 }"
                            ...
                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33] py-[14px]"><img
                                ...
                                src="<?php echo e(asset('front_assets/images/flight-tour-holiday-village-icon.svg')); ?>" width="24"
                        ...
                        <button x-on:click="openTab = 2" :class="{ 'border-b-2 text-dark-blue border-dark-blue': openTab === 2  }"
                            ...
                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33] py-[14px]"><img
                                ...
                                src="<?php echo e(asset('front_assets/images/flight-tour-flight-takeoff-icon.svg')); ?>" width="24"
                        ...
                        <button x-on:click="openTab = 3" :class="{ ' border-b-2 text-dark-blue border-dark-blue': openTab === 3 }"
                            ...
                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33]  py-[14px]"><img
                                ...
                                src="<?php echo e(asset('front_assets/images/flight-tour-hotel-icon.svg')); ?>" width="24" height="24">Hotel</button>

                        <button x-on:click="openTab = 4" :class="{ ' border-b-2 text-dark-blue border-dark-blue': openTab === 4 }"

                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33]  py-[14px]  "><img

                                src="<?php echo e(asset('front_assets/images/flight-tour-car-icon.svg')); ?>" width="24" height="24">Car Rentals</button>

                        <button x-on:click="openTab = 5" :class="{ ' border-b-2 text-dark-blue border-dark-blue': openTab === 5 }"

                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33]  py-[14px]"><img

                                src="<?php echo e(asset('front_assets/images/flight-tour-attraction-icon.svg')); ?>" width="24"
                        ...
                        <button x-on:click="openTab = 6"
                            ...
                            class="flex xl:gap-3 gap-1 xl:text-xl lg:text-base  text-xs transition-all duration-300 text-[#141A33] py-[14px]"><img
                                ...
                                src="<?php echo e(asset('front_assets/images/flight-tour-airport-icon.svg')); ?>" width="24" height="24">Airport
                            Taxis</button>
                    </div>
                        ...
                        <div class="grid items-center justify-center  md:grid-cols-2 lg:grid-cols-4 grid-row gap-4 px-3.5 py-6 trip-info ">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <img src="<?php echo e(asset('front_assets/images/flight-tour-flight-takeoff-icon.svg')); ?>" width="24" height="24">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <img src="<?php echo e(asset('front_assets/images/flight-tour-flight-landing-icon.svg')); ?>" width="24" height="24">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <img src="<?php echo e(asset('front_assets/images/flight-tour_calender-icon.svg')); ?>" width="24" height="24">
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <img src="<?php echo e(asset('front_assets/images/flight-tour_user-icon.svg')); ?>" width="24" height="24">
                    ...
                    <form action="<?php echo e(route('flights.search')); ?>" method="GET">
                    ...
                    <form action="<?php echo e(route('search.hotel')); ?>" method="GET">
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class=" card">
                            ...
                            <div class="w-full card-img">
                                ...
                                <img src="<?php echo e(asset('front_assets/images/flight-tour-package-one.webp')); ?>" alt="flight-tour-package-one"
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class=" card">
                            ...
                            <div class="w-full card-img">
                                ...
                                <img src="<?php echo e(asset('front_assets/images/flight-tour-package-two.webp')); ?>" alt="flight-tour-package-one"
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card">
                            ...
                            <div class="w-full card-img">
                                ...
                                <img src="<?php echo e(asset('front_assets/images/flight-tour-package-three.webp')); ?>" alt="flight-tour-package-one"
        ...
        <div class="grid grid-cols-2 gap-[18px]">
            ...
            <div class=" card">
                ...
                <div class="w-full card-img">
                    ...
                    <img src="<?php echo e(asset('front_assets/images/flight-tour-mobile-pakage-one.webp')); ?>" alt="flight-tour-package-one"
            ...
            <div class=" card">
                ...
                <div class="w-full card-img">
                    ...
                    <img src="<?php echo e(asset('front_assets/images/flight-tour-mobile-pakage-two.webp')); ?>" alt="flight-tour-package-one"
            ...
            <div class="grid md:grid-cols-4 lg:gap-x-[19px] gap-y-7 gap-x-3 grid-cols-2">
                ...
                <div class="bg-white card xl:px-7 lg:px-5 pt-7 md:pb-[38px] px-2 pb-4 shadow-3xl ">
                    ...
                    <div class="card-img">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/Flight-tour-bangladesh-airlines.svg')); ?>" alt="Flight-tour-bangladesh-airlines"
                ...
                <div class="bg-white card xl:px-7 lg:px-5 pt-7 md:pb-[38px] px-2 pb-4 shadow-3xl ">
                    ...
                    <div class="card-img">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/Flight-tour-us-airlines.svg')); ?>" alt="Flight-tour-us-airlines" width="89"
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 md:gap-x-3 md:gap-y-[20px] gap-x-[18px] gap-y-[18px]">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-verrazano.webp')); ?>" width="387" height="258">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-newyork.webp')); ?>" width="387" height="258">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-Francesco Mancini.webp')); ?>" width="387" height="258">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img ">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-Verrazzano-Narrows.webp')); ?>" width="387" height="258">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img ">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-Sunfrancisco.webp')); ?>" width="387" height="258">
                ...
                <div class="relative card">
                    ...
                    <div class="card-img ">
                        ...
                        <img class="w-full" src="<?php echo e(asset('front_assets/images/flight-tour-destination-China.webp')); ?>" width="387" height="258">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-x-[15px] gap-y-6">
                ...
                <div class="px-3 py-6 text-center bg-white shadow-3xl g:py-12 lg:px-12 card ">
                    ...
                    <div class="flex justify-center card-img">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/flight-tour-booking-icon.svg')); ?>" alt="flight-tour-booking-icon" width="103"
                ...
                <div class="px-3 py-6 text-center bg-white shadow-3xl g:py-12 lg:px-12 card ">
                    ...
                    <div class="flex justify-center card-img">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/flight-tour-best-price-icon.svg')); ?>" alt="flight-tour-booking-icon" width="103"
                ...
                <div class="px-3 py-6 text-center bg-white shadow-3xl g:py-12 lg:px-12 card ">
                    ...
                    <div class="flex justify-center card-img">
                        ...
                        <img src="<?php echo e(asset('front_assets/images/flight-tour-customer-care.svg')); ?>" alt="flight-tour-booking-icon" width="103"
...
<?php echo $__env->make('frontend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/index.blade.php ENDPATH**/ ?>