                    ...
                    <div class="flex items-center justify-between ">
                        ...
                        <div class="flex items-center lg:gap-x-24 md:gap-x-10 gap-x-3">
                            <div class="relative select-box z-[2]">
                                <select class="bg-transparent h-10 md:pr-24 pr-16 w-full z-[3] bg-left md:bg-[length:52px_39px] bg-[length:40px_39px] bg-no-repeat select_country_code text-black appearance-none relative" style="background-image: url('<?php echo e(asset('front_assets/images/flight-tour-india-flag.svg')); ?>');">
                                    <option value=""></option>
                            ...
                            <img src="<?php echo e(asset('front_assets/images/flight-tour-login-info-icon.svg')); ?>" alt="info" width="34" height="34" class="w-6 h-6 md:h-auto md:w-auto">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="signin md:py-16 py-8 bg-[#003b951a] bg-no-repeat xl:bg-auto lg:bg-[length:25%_auto] bg-[length:18%_auto]" style="background-image: url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-one.webp')); ?>'), url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-two.webp')); ?>'); background-position: center left, center right;">
        <div class="container relative mx-auto after:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-four.webp')); ?>')] after:absolute after:top-0 after:left-0 xl:after:right-[132px] after:lg:right-2.5 after:right-0 after:bottom-0 after:bg-right-bottom after:-z-[1] after:bg-no-repeat after:lg:bg-[length:auto_auto] after:bg-[length:20%_auto] before:bg-[length:36%_auto] before:xl:bg-[length:auto_auto] before:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-three.webp')); ?>')] before:absolute before:top-0 before:left-0 before:w-full before:bottom-0 before:bg-left-top before:-z-[1] before:bg-no-repeat before:md:block before:hidden after:md:block after:hidden">
            <div class="lg:px-6 md:px-4 px-2.5 bg-white border border-[#0000001a] rounded-2xl md:py-9 py-6 xl:w-[41%] lg:w-1/2 md:w-4/6 w-full mx-auto text-center">
                ...
                <form action="<?php echo e(route('front.create_user_1')); ?>" class="block mt-4 text-start lg:mt-9 md:mt-5 row">
                    ...
                    <div class="col-md-6 mb-5 md:mb-7">
                        ...
                        <div class="flex items-end md:gap-x-3 gap-x-2.5">
                            <div class="border border-[#9E9E9E] rounded px-3.5 py-1.5 h-14 md:w-[28%] w-1/3 flex items-center">
                                <select class="w-full h-full md:w-3/4" style="background-image: url('<?php echo e(asset('front_assets/images/flight-tour-circle-flag-icon.svg')); ?>'); background-position: left center; background-repeat: no-repeat;">
                                    <option value=""></option>
                    ...
                    <div class="col-md-6">
                        <p class="text-base text-[#505673]">
                            ...
                            <a href="<?php echo e(route('front.login')); ?>" class="text-dark-blue font-semibold hover:underline">Log in here</a>.
                        </p>
                    </div>
...
</html><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/user_login/registration.blade.php ENDPATH**/ ?>