...
<body>
                ...
                <div class="flex flex-col w-full text-white">
                    <div class="flex items-center justify-between ">
                        <a href="<?php echo e(route('front.index')); ?>">
                            <img src="<?php echo e(asset('front_assets/images/flight-tour-logo.svg')); ?>" alt="Logo" width="180" height="48" />
                        </a>
                        ...
                        <div class="flex items-center lg:gap-x-24 md:gap-x-10 gap-x-3">
                            <div class="relative select-box z-[2]">
                                <select
                                    ...
                                    style="background-image: url('<?php echo e(asset("front_assets/images/flight-tour-india-flag.svg")); ?>');">
                            ...
                            <img src="<?php echo e(asset('front_assets/images/flight-tour-login-info-icon.svg')); ?>" alt="info" width="34" height="34"
    ...
    <section
        ...
        style="background-image: url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-one.webp')); ?>'), url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-two.webp')); ?>'); background-position: center left, center right;">
        <div
            class="container relative mx-auto after:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-four.webp')); ?>')] after:absolute after:top-0 after:left-0 xl:after:right-[132px] after:lg:right-2.5 after:right-0 after:bottom-0 after:bg-right-bottom after:-z-[1] after:bg-no-repeat after:lg:bg-[length:auto_auto] after:bg-[length:20%_auto] before:bg-[length:36%_auto] before:xl:bg-[length:auto_auto] before:bg-[url('<?php echo e(asset('front_assets/images/flight-tour-bg-login-three.webp')); ?>')] before:absolute before:top-0 before:left-0 before:w-full before:bottom-0 before:bg-left-top before:-z-[1] before:bg-no-repeat before:md:block before:hidden after:md:block after:hidden">
            <div
                ...
                <h2 class="text-xl font-semibold xl:text-4xl text-black-400">Sign In to manage property</h2><br>
                ...
                <form action="<?php echo e(route('loginuser')); ?>" class="block mt-4 text-start lg:mt-9 md:mt-5">
                    ...
                    <div
                        ...
                        <input type="text" name="identifier" placeholder="Enter Email or Phone Number"
                            class="w-full placeholder:text-black-400 placeholder:font-medium">
                    ...
                    <div class="w-full border rounded-[5px] border-[#9E9E9E] px-3.5 py-1.5 flex md:gap-x-4 gap-x-2 h-14">
                        <!-- <img src="images/flight-tour-password-key.svg" alt="email" width="24" height="24"> -->
                        <input type="password" placeholder="Enter your password" name="password" class="w-full">
                        <!-- <img src="images/flight-tour-eye-icon.svg" alt="email" width="24" height="24"> -->
                    </div>
                    <br>
                    <p class="text-base text-[#505673]">
                        Don't have an account yet?
                        <a href="<?php echo e(route('front.registration')); ?>" class="text-dark-blue font-semibold hover:underline">Register here</a>
                    </p>
                    <p class="text-base text-[#505673]">
                        if you don't remember password?
                        <a href="<?php echo e(route('frontuser.password.request')); ?>" class="text-dark-blue font-semibold hover:underline">Reset Password</a>.
                    </p>
                    <button class="font-semibold text-light-brown md:text-[22px] text-lg bg-dark-blue rounded px-6 md:py-4 py-3.5 w-full md:mt-7 mt-5 md:mb-8 mb-5 hover:bg-transparent hover:border hover:border-dark-blue hover:text-dark-blue transition">Sign In</button>
                </form>
                <!-- <a href="<?php echo e(route('front.registration')); ?>"
    ...
    <script src="<?php echo e(asset('front_assets/src/jquery.min.js')); ?>"></script>
</body>

</html><?php /**PATH /home/dmprojects/public_html/ankitsaini/flight_tour/resources/views/frontend/user_login/login.blade.php ENDPATH**/ ?>